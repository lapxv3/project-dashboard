...
const UniversityTable = ({ listOfUniversity: listOfBrands }: Props) => {
          ...
          <>
            ...
            <div className="max-w-full overflow-x-auto">
              <table className="w-full ">
                ...
                <tbody>
                  {brandData.map((packageItem: any, index) => (
                    <tr key={index}>
                      <td
                        className={`border-[#eee] px-8 py-4 dark:border-dark-3 xl:pl-7.5 ${index === packageItem.length - 1 ? "border-b-0" : "border-b"}`}
                      >
                      ...
                      <td
                        className={`border-[#eee] px-8 py-4 dark:border-dark-3 ${index === packageItem.length - 1 ? "border-b-0" : "border-b"}`}
                      >
                      ...
                      <td
                        className={`border-[#eee] px-5 py-4 dark:border-dark-3 ${index === packageItem.length - 1 ? "border-b-0" : "border-b"}`}
                      >
                        <p className="text-dark dark:text-white">
                          {packageItem.brandDescription}
                        </p>
