...
const SubCategoryTable = ({ listOfSubCategories }: Props) => {
  console.log('first',listOfSubCategories)
  ...
  const filteredCategories = listOfSubCategories.filter((categoryItem: any) =>
  ...
  async function featuredSubCategory(subCategoryId: any) {
    try {
      const featuredSubCategory = await subCategoryApi.featuredSubCategory(subCategoryId);

      if (featuredSubCategory.data.success) {
                        ...
                        <label className="flex cursor-pointer select-none items-center">
                          <div className="relative">
                            <input
                              ...
                              className="sr-only"
                              onChange={async () => {
                                await featuredSubCategory(packageItem._id);
                              }}
                            />
