...
const CategoryfoodTable = ({ listOfUniversity: listOfBrands }: Props) => {
  ...
  const filteredBrands = listOfBrands.filter((brandItem: any) =>
    brandItem.categoryName.toLowerCase().includes(searchTerm.toLowerCase()),
  );
                    ...
                    ${packageItem.price}
                      ...
                      >
                        <div className="flex items-center justify-end space-x-3.5">
                          <Link href={`/categoryfood/edit/${packageItem._id}`}>
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              width="20"
                              height="20"
...
export default CategoryfoodTable;  
