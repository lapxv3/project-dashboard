...
const SelectDropdown = ({ register, name, data }: SProps) => {
    ...
    <div>
      ...
      <div className="relative z-20 rounded-[7px] bg-white dark:bg-dark-2 ">
        ...
        {...register}
          ...
          className={`relative z-10 w-full appearance-none rounded-[7px] border border-stroke bg-transparent py-3 pl-5.5 pr-11.5 outline-none transition focus:border-primary active:border-primary dark:border-dark-3 dark:bg-dark-2 ${
