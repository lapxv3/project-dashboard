...
const mySchema = z.object({
  foodId: z.string().trim().min(1, { message: "Food Id is required." }),
  foodName: z.string().trim().min(1, { message: "Food Name is required." }),
...
const FooditemAddForm = () => {
  ...
  return (
    <>
      ...
      <Breadcrumb pageName="ADD FOOD" navigation={navigationData} />
